...
def test_get_all_initially_returns_empty_list():
    """Ensure the repository starts empty."""
...
def test_add_returns_the_added_ingredient():
    """Ensure add returns the ingredient it stored."""
    repo = IngredientRepository()
    ...
    returned_ingredient = repo.add(ingredient)

    assert returned_ingredient == ingredient


def test_get_by_name_found():
    """Ensure get_by_name returns the correct ingredient."""
    repo = IngredientRepository()
    ingredient = Ingredient(
        id=1,
        name="Sugar",
...
def test_get_by_name_not_found():
    """Ensure get_by_name returns None when ingredient does not exist."""
    repo = IngredientRepository()
