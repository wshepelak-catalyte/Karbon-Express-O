...
@pytest.mark.parametrize(
    "id, name, cost_to_produce, markup_percentage, sale_price",
    [
        (1, "Espresso", Decimal("0.50"), Decimal("3.0"), Decimal("2.00")),
        (2, "Latte", Decimal("0.80"), Decimal("2.5"), Decimal("2.80")),
        (3, "Water", Decimal("0.00"), Decimal("0.0"), Decimal("0.00")),
    ]
)
...
def test_drink_id_attribute_type_is_int(valid_drink):
    assert isinstance(valid_drink.id, int)
