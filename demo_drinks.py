...
def print_menu() -> None:
    ...
    print("6. Delete drink by name")  #delete_drink 
    print("7. Get available drinks")  #get_available_drinks
    print("8. Run full demo sequence")
    print("0. Exit")
        ...
        def main() -> None:
            ...
            while True:
                ...
                if choice == "1":
                    ...
                    drink = repository.get_by_name(name)
                    if drink:
                    ...
                    result = repository.update(name, updated_drink)
                    if result:
                    ...
                    success = repository.delete(name)
                    if success:
                    ...
                    available_drinks = [drink for drink in repository.get_all() if drink.is_available]
